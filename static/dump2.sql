...
INSERT INTO `products_tech` VALUES (1,'Общее описание','<p>пиорп орп ора прарпарп</p>','default','',10,1),(2,'Сборка','<p>оролрол</p>','assemble','',10,1),(3,'Технические характеристики','<p>jjj</p>','requirements','',10,1),(4,'Утепление','<p>Утепление</p>','warmer','',10,1);
...
-- Dump completed on 2013-02-04 19:42:55
